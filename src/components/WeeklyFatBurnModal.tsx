...
export const WeeklyFatBurnModal = () => {
    ...
    // Aggregate 7-day intake and gym count
    ...
    return (
        <>
            {/* Floating Jiggling Fat Burn Badge (Floating Bottom Left) */}
            <aside aria-label="Weekly fat burn telemetry" className="fixed bottom-24 left-4 z-40">
                ...
                >
                    {/* Pulsing & Jiggling Fat Burn Icon */}
            ...
            {/* Interactive Weekly Overview Modal (Full English) */}
            {isOpen && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
                    <div className="bg-off-white text-brutal-black border-2 border-brutal-black w-full max-w-md rounded-3xl p-6 shadow-2xl animate-in zoom-in-95 duration-200 relative max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-5">
                            <div className="bg-white/80 backdrop-blur-sm p-3.5 rounded-xl border border-brutal-black/10">
                                ...
                                <span className="font-sans text-[10px] opacity-60">
                                    Ø {dailyAvgIntake.toLocaleString()} kcal / day
                                </span>
                            </div>
                            ...
                            <div className="bg-white/80 backdrop-blur-sm p-3.5 rounded-xl border border-brutal-black/10">
                                <div className="flex items-center justify-between">
                                    ...
                                    {telemetry.isSmartwatchOverride ? (
                                        <span className="text-[9px] font-bold text-indigo-600 uppercase tracking-wider">Watch</span>
                                    ) : (
                                ...
                                <span className="font-sans text-[10px] opacity-60">
                                    Ø {dailyAvgBurn.toLocaleString()} kcal / day {exerciseDaysCount > 0 && `(${exerciseDaysCount}× gym)`}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-indigo-50/60 rounded-2xl border border-indigo-100 mb-5">
                            ...
                            <p className="font-sans text-[11px] leading-relaxed text-indigo-950/70 mb-3">
                                Enter your total 7-day active + resting burn from Apple Watch, Garmin, Whoop, or Galaxy Watch.
                            </p>
                            ...
                            <span className="font-sans text-[10px] text-indigo-900/50 block mb-3">
                                Profile baseline model: {telemetry.weeklyMaintenanceTDEE.toLocaleString()} kcal
                            </span>
