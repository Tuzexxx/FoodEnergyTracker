                        ...
                        <div className="flex flex-col gap-2.5">
                            ...
                            >
                                ...
                                <div className="flex flex-col min-w-0">
                                    <span className="text-brutal-black font-semibold truncate">{t.smartLogging.takePhoto}</span>
                                    <span className="text-[11px] font-normal opacity-50 truncate">{t.smartLogging.takePhotoSub}</span>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="flex flex-col min-w-0">
                                    <span className="text-brutal-black font-semibold truncate">{t.smartLogging.chooseGallery}</span>
                                    <span className="text-[11px] font-normal opacity-50 truncate">{t.smartLogging.chooseGallerySub}</span>
                                </div>
                            </button>
                            ...
                            <button
                                ...
                                className="flex items-center gap-3 w-full p-3.5 bg-black/5 hover:bg-black/10 rounded-2xl font-sans font-bold text-sm transition-all active:scale-98 text-left"
                            >
                                <div className="p-2.5 bg-violet-600 text-white rounded-xl shadow-sm shrink-0">
                                    <LayoutGrid size={18} />
                                </div>
                                <div className="flex flex-col min-w-0">
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-brutal-black font-semibold truncate">{t.smartLogging.batchUpload}</span>
                                        <span className="bg-gradient-to-r from-amber-400 to-orange-500 text-white text-[8px] font-bold uppercase px-1.5 py-0.5 rounded-full leading-none tracking-wider shrink-0">PRO</span>
                                    </div>
                                    <span className="text-[11px] font-normal opacity-50 truncate">{t.smartLogging.batchUploadSub}</span>
                                </div>
                            </button>
                        </div>
                    </div>
                                        ...
                                        <div key={`edit-${i}`} className="bg-white/60 backdrop-blur-2xl flex flex-col gap-3 p-3 rounded-2xl w-full border border-white/40 shadow-2xl z-50 animate-in zoom-in-95 data-[state=closed]:zoom-out-95 duration-200">
                                            ...
                                            <div className="flex flex-wrap justify-between items-center mt-1 border-t border-black/5 pt-2 gap-2">
                                                ...
                                                <div className="flex gap-1.5 flex-1 justify-end min-w-fit">
                                                    ...
                                                    >
                                                        {isFavAdjusting ? <Activity size={14} className="animate-spin" /> : <Activity size={14} />} <span>{t.common.adjust}</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
