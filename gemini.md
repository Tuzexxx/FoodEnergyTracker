...
## 🛰️ AI Architecture (Gemini 3.1 Flash Lite)

The application leverages **Gemini 3.1 Flash Lite** via a Vercel Serverless Function (`/api/analyze.ts`) for high-speed food logging and image telemetry.
