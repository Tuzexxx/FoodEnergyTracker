...
## 🛰️ AI Architecture (Gemini 2.5 Pro)

The application leverages **Gemini 2.5 Pro** via a Vercel Serverless Function (`/api/analyze.ts`) for high-precision food logging and image telemetry.
